          ...
          groups: [
            {
              ...
              groupFields: [
                ...
                PropertyFieldColumnPicker('list1column1', {
                  ...
                  onPropertyChange: this.onPropertyPaneFieldChanged.bind(this),
                  properties: this.properties,
                  filter: "Hidden eq false and ReadOnlyField eq false and FieldTypeKind eq 2",
                  onGetErrorMessage: null,
                  deferredValidationTime: 0,
                ...
                PropertyFieldColumnPicker('list1column2', {
                  ...
                  onPropertyChange: this.onPropertyPaneFieldChanged.bind(this),
                  properties: this.properties,
                  filter: "Hidden eq false and FieldTypeKind eq 4",
                  onGetErrorMessage: null,
                  deferredValidationTime: 0,
                ...
                PropertyFieldColumnPicker('list1column5', {
                  ...
                  onPropertyChange: this.onPropertyPaneFieldChanged.bind(this),
                  properties: this.properties,
                  filter: "FieldTypeKind eq 29 or FieldTypeKind eq 8",
                  onGetErrorMessage: null,
                  deferredValidationTime: 0,
                  key: 'columnPickerFieldId4',
                  displayHiddenColumns: false,
